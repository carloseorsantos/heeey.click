...
## 🔐 Conectando sua Conta (Magic Link)
...
### Como entrar:
1. No Dashboard ou no menu superior do quadro, clique em **"Entrar"**.
2. Digite seu endereço de e-mail.
3. Um código OTP de 6 dígitos será enviado instantaneamente para a sua caixa de entrada.
4. Digite o código na tela para confirmar. Pronto! Não é necessário lembrar senhas.
