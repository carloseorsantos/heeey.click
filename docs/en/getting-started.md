...
### How to sign in:
1. On the dashboard or in the board's top menu, click **"Sign in"**.
2. Enter your email address.
3. A 6-digit OTP code is sent instantly to your inbox.
4. Type the code on screen to confirm. That's it! No passwords to remember.
