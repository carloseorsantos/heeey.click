...
## 🔐 Conecta tu cuenta (Google o Magic Link)
...
1. En la página de inicio, haz clic en **«Crear cuenta gratis»**.
2. Escribe tu dirección de correo electrónico y confirma que tienes 16 años o más y aceptas los Términos de uso y la Política de privacidad.
3. Haz clic en **«Enviar enlace de acceso»** y abre el enlace que recibas por correo en este mismo navegador. ¡Listo! No hay contraseñas que recordar.

### Cómo iniciar sesión:
1. En la página de inicio, en el panel o en el menú de tu avatar, haz clic en **«Iniciar sesión»**.
2. Escribe el correo de tu cuenta y haz clic en **«Enviar enlace de acceso»**.
3. Abre el enlace que recibas por correo en este mismo navegador.

### Iniciar sesión con Google:
En las mismas pantallas, haz clic en **«Continuar con Google»** y elige tu cuenta de Google. Al crear una cuenta, marca antes la confirmación de edad y de los términos. Si ya existe una cuenta de Heeey con el mismo correo, Google inicia sesión en ella; no se crea una cuenta nueva. De Google solo recibimos tu nombre, correo y foto de perfil.
